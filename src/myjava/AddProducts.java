...
public class AddProducts extends HttpServlet {
    ...
    private final String UPLOAD_DIRECTORY = "C:\\Users\\lenovo\\eclipse-work\\ecommerce\\WebContent\\uploads";
            ...
            try {
                ...
                for (FileItem item : multiparts) {
                    if (!item.isFormField()) {
                        ...
                        File file = new File(UPLOAD_DIRECTORY + File.separator + imageName);
                        item.write(file);
