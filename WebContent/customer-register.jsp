                        ...
                        <div class="login">
                            <div class="login-bottom">
                                ...
                                <form action="AddCustomer" method="post">
                                    ...
                                    <div class="sign-up">
                                        <h4 style="margin-bottom:6px;">Email :</h4>
                                        <input type="email" placeholder="Your email" required="" style="width: 680px;margin-bottom:15px;" name="email">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Password :</h4>
                                    ...
                                    <div class="sign-up">
                                        <h4>Phone :</h4>
                                        <input type="text" placeholder="Your number" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required="" style="width: 680px;margin-bottom:10px;margin-top:6px;" name="mobile">
                                    </div>
                                    <div class="sign-up">
                                        <h4>Gender :</h4>
