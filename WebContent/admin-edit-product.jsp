                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <form role="form" action="admin-edit-product-process.jsp"
                                    ...
                                    <div class="form-group">
                                        <label>Price</label> <input class="form-control" type="number" min="0" name="price" value="<%=updateResult.getString("price")%>" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>MRP Price</label> <input class="form-control" type="number" min="0" name="mprice" value="<%=updateResult.getString("mrp_price")%>" />
                                    </div>
                                    <div class="form-group">
